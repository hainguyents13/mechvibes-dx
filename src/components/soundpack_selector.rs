                ...
                button {
                    ...
                    div {
                        ...
                        if let Some(pack) = current_soundpack() {
                            div {
                                class: "flex-shrink-0 overflow-hidden bg-blend-multiply w-10 h-10 bg-base-200 rounded-lg flex items-center justify-center",
                                if is_loading() {
                                ...
                                for pack in filtered_soundpacks.read().iter() {
                                    button {
                                        ...
                                        div {
                                            ...
                                            div {
                                                class: "flex-shrink-0 w-8 h-8 rounded-lg flex items-center justify-center bg-base-100 overflow-hidden bg-blend-multiply ",
                                                if let Some(icon) = &pack.icon {
                                                    if !icon.is_empty() {
                                                        img {
                                                            class: "w-full h-full object-cover",
