...
pub fn Logo() -> Element {
    ...
    let base = "border-black select-none border-4 font-black block py-6 px-8 pt-7 text-5xl rounded-2xl transition-all duration-150 ease-in-out bg-base-300 flex justify-center items-center";
