...
pub fn TitleBar() -> Element {
    ...
    rsx! {
      div { class: "fixed inset-0 h-10 z-999 flex justify-between items-center select-none gap-0 bg-gradient-to-b from-base-300/80 to-transparent backdrop-blur-md transition-all ",
